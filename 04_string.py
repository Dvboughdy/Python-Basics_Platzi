...
# Concatenación
full_name = name + " " + last_name  # Para que la concatenación no se muestre unida se pone " " para representar un espacio vacio
print(full_name)
...
nombre_variable = "Hola mi nombre es {} y mi apellido es {}".format(
    name, last_name)
